...
*A: <mark>I look at the read/write ratio and the cost of a cache miss. Expensive-to-compute, rarely-changing, frequently-read data</mark> — like a user profile or a product catalog page — is the sweet spot. I'd instrument actual query patterns first rather than guessing; caching the wrong things just adds invalidation complexity for no latency win.*
...
```mermaid
graph TD
    HK[Celebrity's viral post: key = #quot;post:999#quot;] --> N[Single Node B owns this key]
