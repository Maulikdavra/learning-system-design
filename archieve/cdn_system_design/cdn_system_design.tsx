...
const CDNSystemDesign = () => {
  ...
  const Section = ({ id, title, icon: Icon, children }: SectionProps) => {
    ...
    return (
      <div className="mb-6 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300">
        <button
          onClick={() => toggleSection(id)}
          className="w-full px-8 py-6 bg-gradient-to-r from-slate-50 via-blue-50 to-indigo-50 hover:from-blue-100 hover:via-indigo-100 hover:to-purple-100 flex items-center justify-between transition-all duration-300 group"
        >
          <div className="flex items-center gap-4">
            ...
            <span className="font-bold text-xl text-gray-800 group-hover:text-indigo-700 transition-colors duration-300">{title}</span>
          </div>
          <div className={`p-2 rounded-lg transition-all duration-300 ${isExpanded ? 'bg-indigo-100 text-indigo-700' : 'bg-gray-100 text-gray-600 group-hover:bg-indigo-100 group-hover:text-indigo-700'}`}>
            {isExpanded ? <ChevronDown className="w-6 h-6" /> : <ChevronRight className="w-6 h-6" />}
          </div>
        </button>
        {isExpanded && (
          <div className="px-8 py-6 bg-gradient-to-br from-white to-slate-50 border-t border-gray-100">
            {children}
          </div>
        )}
      </div>
  ...
  const QA = ({ q, a, intuition }: QAProps) => (
    <div className="mb-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100 shadow-lg hover:shadow-xl transition-all duration-300">
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="font-bold text-lg text-gray-800 leading-relaxed">{q}</div>
      </div>
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="text-gray-700 leading-relaxed">{a}</div>
      </div>
      {intuition && (
        <div className="mt-4 p-5 bg-gradient-to-br from-amber-50 to-yellow-100 rounded-xl border-l-4 border-amber-400 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="text-sm font-bold text-amber-800">Intuition:</div>
          </div>
          <div className="text-sm text-amber-900 leading-relaxed">{intuition}</div>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 text-white p-10 rounded-2xl mb-8 shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 bg-black opacity-5"></div>
          <div className="relative z-10">
            <h1 className="text-5xl font-extrabold mb-4 leading-tight bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
              System Design: Content Delivery Network (CDN)
            </h1>
            <p className="text-xl text-blue-100 font-medium">A comprehensive interview guide with questions, answers, and intuitions</p>
          </div>
          <div className="absolute top-4 right-4 w-32 h-32 bg-white opacity-5 rounded-full"></div>
          <div className="absolute bottom-4 left-4 w-20 h-20 bg-white opacity-5 rounded-full"></div>
        </div>
      ...
      <Section id="requirements" title="Phase 1: Requirements Gathering" icon={Database}>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-2xl border border-blue-200 shadow-lg mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center">
              <Database className="w-5 h-5 text-white" />
            </div>
            <h4 className="font-bold text-gray-800 text-lg">Functional Requirements</h4>
          </div>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Serve static content (images, videos, CSS, JS, HTML)</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Fetch content from origin servers when not cached</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Cache content at edge locations close to users</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Support cache invalidation/purging</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Route users to nearest edge location</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed">Support SSL/TLS termination</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-green-100 p-6 rounded-2xl border border-emerald-200 shadow-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="font-bold text-gray-800 text-lg">Non-Functional Requirements</h4>
          </div>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed"><strong className="text-emerald-700">Availability:</strong> 99.99% uptime (52 minutes downtime/year)</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed"><strong className="text-emerald-700">Latency:</strong> Sub-100ms for 95% of requests</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed"><strong className="text-emerald-700">Scalability:</strong> Handle 100M requests/second globally</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed"><strong className="text-emerald-700">Consistency:</strong> Eventual consistency is acceptable</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="leading-relaxed"><strong className="text-emerald-700">Reliability:</strong> Graceful degradation on failures</span>
            </li>
          </ul>
        </div>
      </Section>
      ...
      <Section id="capacity" title="Phase 2: Capacity Estimation" icon={Server}>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-gray-800 p-6 rounded-2xl font-mono text-sm space-y-3 mb-6 shadow-xl border border-gray-700">
          <div className="text-blue-300 font-bold text-base mb-4">📊 Capacity Calculations</div>
          
          <div className="border-l-4 border-blue-400 pl-4 mb-4">
            <div className="text-blue-300 font-bold mb-2">Traffic Estimation:</div>
            <div className="text-gray-300 space-y-1">
              <div>• <span className="text-yellow-400">100M requests/second</span> globally</div>
              <div>• Average object size: <span className="text-green-400">100 KB</span></div>
              <div>• Bandwidth: 100M req/s × 100 KB = <span className="text-red-400">10 TB/second = 80 Terabits/second</span></div>
              <div>• Daily data transfer: 10 TB/s × 86,400s = <span className="text-purple-400">864 PB/day</span></div>
            </div>
          </div>
          
          <div className="border-l-4 border-green-400 pl-4 mb-4">
            <div className="text-green-300 font-bold mb-2">Storage Estimation:</div>
            <div className="text-gray-300 space-y-1">
              <div>• Assume we cache 20% of all content (80/20 rule)</div>
              <div>• Unique objects: ~<span className="text-yellow-400">100 billion objects</span></div>
              <div>• Total cached storage needed: 100B × 100KB × 0.2 = <span className="text-red-400">2 Exabytes</span></div>
              <div>• Per edge location (assume 200 locations): ~<span className="text-purple-400">10 PB each</span></div>
            </div>
          </div>
          
          <div className="border-l-4 border-purple-400 pl-4">
            <div className="text-purple-300 font-bold mb-2">Memory Estimation (Hot Cache):</div>
            <div className="text-gray-300 space-y-1">
              <div>• Keep 1% of content in memory for ultra-fast access</div>
              <div>• Memory per location: <span className="text-orange-400">100 TB</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-indigo-100 p-6 rounded-2xl border border-purple-200 shadow-lg">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h4 className="font-bold text-purple-900">Key Insight</h4>
          </div>
          <p className="text-purple-800 leading-relaxed">These numbers seem massive, but they're realistic for a global CDN. This validates that we need a distributed system with no single point of failure. We'll use a multi-tier caching strategy: <span className="font-semibold">memory → SSD → HDD → origin</span>.</p>
        </div>
      </Section>
